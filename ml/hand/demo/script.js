...
const onReceivedPoses = (packet) => {
  ...
  for (const poses of handsData.handedness) {
    for (const hand of poses) {
      console.log(`${hand.index} ${hand.displayName} score: ${hand.score}`);
    }
  }

  //console.dir(handsData.handedness);
  return;
