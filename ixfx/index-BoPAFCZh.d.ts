import { G as Grid, d as GridWritable, e as GridReadable, b as GridCellAccessor, c as GridCellSetter, S as ScaleBy } from './Scaler-CE9loi0A.js';
...
import { E as ElementResizeLogic, C as CanvasHelper } from './CanvasHelper-CZAo81Wm.js';
...
declare class CartesianCanvasPlot {
    ...
    margin: number;
    constructor(domQueryOrEl: HTMLCanvasElement | string, data: DataSet<PlotPoint, SeriesMeta>, options?: RecursivePartial<CartesianPlotOptions>);
     ...
     * @param by
     */
    positionAt(data: Point, elOrQuery: HTMLElement | string, by?: `middle` | `top-left`, relativeToQuery?: HTMLElement | string): void;
    /**
...
declare namespace index {
  export { BipolarView$1 as BipolarView, index_CartesianCanvasPlot as CartesianCanvasPlot, index_Colour as Colour, index_Drawing as Drawing, index_ImageDataGrid as ImageDataGrid, Palette$1 as Palette, index$1 as Plot, index_SceneGraph as SceneGraph, index_Svg as Svg, index_Video as Video };
}

export { BipolarView$1 as B, CartesianCanvasPlot as C, ImageDataGrid as I, Palette$1 as P, SceneGraph as S, index$1 as a, index as i };
