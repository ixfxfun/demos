...
import { cloneState, elapsedInfinity$2 as elapsedInfinity, elapsedSince$2 as elapsedSince, init, isDone, isValidTransition, possible, to$2 as to, validateTransition } from "./state-machine-Ds0cgQaV.js";
import { intervalToMs$2 as intervalToMs } from "./interval-type-CiSB_YRT.js";
import { resolve$2 as resolve, resolveWithFallbackSync$2 as resolveWithFallbackSync } from "./resolve-core-B7KaxY5U.js";
...
import { interpolate$6 as interpolate, interpolateAngle$4 as interpolateAngle } from "./interpolate-CTwhqCyQ.js";
import { guard$1, guard$2 as guard, guardDim, isPoint, isPoint3d } from "./guard-BeN0YudQ.js";
import { Empty, Unit, angleRadian, clampMagnitude, distance, divide, interpolate$7 as interpolate$1, isCubicBezier, isQuadraticBezier, multiply, multiplyScalar, normalise, subtract, sum$4 as sum } from "./guard-K9i92mts.js";
...
//#endregion
export { arcShape, crossfade, cubicBezierShape, drift, easing_exports, envelope_exports, forces_exports, gaussian, interpolate$2 as interpolate, interpolateAngle$1 as interpolateAngle, interpolatorInterval, interpolatorStepped, jitter, jitterAbsolute, mix, mixModulators, modulation_exports, noop, oscillator_exports, pingPong, pingPongPercent, sineBipolarShape, sineShape, source_exports, spring, springShape, springValue, squareShape, tickModulator, ticks$1 as ticks, time$1 as time, timeModulator, timingSourceFactory, triangleShape, wave, waveFromSource, weighted, weightedAverage, weightedSource };
//# sourceMappingURL=modulation-DFItgf11.js.map