...
function multiply3(a, b, c) {
  return apply2(multiplyOp, a, b, c);
}
...
function subtract3(a, b, c) {
  return apply2(subtractOp, a, b, c);
}
...
var indexFromCell = (grid, cell, wrap) => {
  guardGrid(grid, `grid`);
  if (cell.x < 0) {
    switch (wrap) {
      case `stop`: {
...
var interpolate4 = (amount, arc, origin) => {
  guard5(arc);
...
//# sourceMappingURL=chunk-BHY7TTTH.js.map