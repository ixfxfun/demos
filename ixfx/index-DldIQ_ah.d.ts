...
//#endregion
export { numberDecimalTest as A, arrayTest as B, equalWithPrecisionTest as C, integerTest as D, integerParse as E, isFunction as F, ResultOrFunction as G, Result as H, isDefined as I, nullUndefTest as L, numberTest as M, percentTest as N, isInteger as O, functionTest as P, arrayIndexTest as R, testPlainObjectOrPrimitive as S, integerArrayTest as T, ResultError as U, NumberGuardRange as V, ResultOk as W, throwIfFailed as _, errorResult as a, rangeTest as b, resultFirstFail_ as c, resultThrow as d, resultThrowSingle as f, resultsCollate as g, resultWithFail as h, IxfxError as i, numberInclusiveRangeTest as j, isPowerOfTwo as k, resultIsError as l, resultToValue as m, StringGuardRange as n, getErrorMessage as o, resultToError as p, stringTest as r, resultErrorToString as s, index_d_exports as t, resultIsOk as u, ExpectedOpts as v, ifNaN as w, testPlainObject as x, rangeIntegerTest as y, arrayStringsTest as z };