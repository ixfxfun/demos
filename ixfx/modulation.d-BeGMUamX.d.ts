...
import { HasCompletion$1 as HasCompletion } from "./continuously.d-j1jOVnhw.js";
import { Interval$1 as Interval } from "./types.d-lHZ4ldGI.js";
import { SimpleEventEmitter$3 as SimpleEventEmitter } from "./simple-event-emitter.d-BIH9PRmL.js";
import { Point, Rect, RectPositioned } from "./rect-types.d-B8mvza74.js";
...
declare namespace modulation_d_exports {
  export { Drifter, EasingName, EasingOptions, EasingTickOptions, EasingTimeOptions, index_d_exports as Easings, forces_d_exports as Forces, InterpolateOptions, JitterOpts, Jitterer, ModSettable, ModSettableFeedback, ModSettableOptions, ModSource, index_d_exports$2 as Modulation, ModulationFunction, ModulatorTimed, oscillator_d_exports as Oscillators, index_d_exports$1 as Sources, SpringOptions, TimingSourceFactory, TimingSources, WaveModulator, WaveOptions, WaveShaperFeedback, Waveforms, WeightedOptions, arcShape, crossfade, cubicBezierShape, drift, gaussian, interpolate, interpolateAngle, interpolatorInterval, interpolatorStepped, jitter, jitterAbsolute, mix, mixModulators, noop, pingPong, pingPongPercent, sineBipolarShape, sineShape, spring, springShape, springValue, squareShape, tickModulator, ticks, time, timeModulator, timingSourceFactory, triangleShape, wave, waveFromSource, weighted, weightedAverage, weightedSource };
}
//#endregion
export { Drifter, EasingName, EasingOptions, EasingTickOptions, EasingTimeOptions, InterpolateOptions, JitterOpts, Jitterer, ModSettable, ModSettableFeedback, ModSettableOptions, ModSource, ModulationFunction, ModulatorTimed, SpringOptions, TimingSourceFactory, TimingSources, WaveModulator, WaveOptions, WaveShaperFeedback, Waveforms, WeightedOptions, arcShape as arcShape$1, crossfade as crossfade$1, cubicBezierShape as cubicBezierShape$1, drift as drift$1, forces_d_exports, gaussian as gaussian$2, index_d_exports as index_d_exports$20, index_d_exports$1 as index_d_exports$21, index_d_exports$2 as index_d_exports$22, interpolate as interpolate$5, interpolateAngle as interpolateAngle$3, interpolatorInterval as interpolatorInterval$1, interpolatorStepped as interpolatorStepped$3, jitter as jitter$1, jitterAbsolute as jitterAbsolute$1, mix as mix$1, mixModulators as mixModulators$1, modulation_d_exports, noop as noop$1, oscillator_d_exports, pingPong as pingPong$1, pingPongPercent as pingPongPercent$1, sineBipolarShape as sineBipolarShape$1, sineShape as sineShape$1, spring as spring$1, springShape as springShape$1, springValue as springValue$1, squareShape as squareShape$1, tickModulator as tickModulator$1, ticks as ticks$1, time as time$1, timeModulator as timeModulator$1, timingSourceFactory as timingSourceFactory$1, triangleShape as triangleShape$1, wave as wave$1, waveFromSource as waveFromSource$1, weighted as weighted$2, weightedAverage as weightedAverage$1, weightedSource as weightedSource$2 };
//# sourceMappingURL=modulation.d-BeGMUamX.d.ts.map