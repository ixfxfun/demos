...
__export(iterables_exports, {
  ...
  asCallback: () => asCallback4,
  chunks: () => chunks3,
  combineLatestToArray: () => combineLatestToArray2,
  compareValuesShallow: () => compareValuesShallow,
  concat: () => concat3,
...
async function asCallback3(valueToWrap, callback, onDone) {
  const outputType = typeof valueToWrap === `function` ? valueToWrap() : valueToWrap;
  for await (const value of outputType) {
    callback(value);
  }
...
function some4(it, f) {
  return isAsyncIterable(it) ? some3(it, f) : some2(it, f);
}
...
function asCallback4(input, callback, onDone) {
...
export {
  ...
  fromFunction,
  fromFunctionAwaited,
  asCallback4 as asCallback,
  iterables_exports
};
//# sourceMappingURL=chunk-GJOFPRJR.js.map