import { C as CirclePositioned, a as Circle, b as CircleRandomPointOpts } from './CircleType-HV1S_Vyw.js';
import { P as Path, C as CompoundPath$1, D as Dimensions, W as WithBeziers } from './PathType-BjzQ3mag.js';
import { P as Point, a as Point3d, b as Placeholder$2 } from './PointType-DYug3Yo5.js';
import { R as RandomSource } from './Types-CR0Pe5zY.js';
import { T as Triangle, Q as QuadraticBezier, C as CubicBezier, a as CubicBezierPath, b as QuadraticBezierPath, c as Arc, A as ArcPositioned, d as Ellipse } from './ArcType-BQP6bHin.js';
import { a as RectPositioned, R as Rect, b as RectArray, c as RectPositionedArray } from './RectTypes-Brg8Cmy-.js';
import { P as PolyLine, L as Line } from './LineType-FU9c78oU.js';
import { a as CardinalDirection, b as Cell, G as Grid, C as CellAccessor, V as VisitGenerator, c as Grid$1 } from './Grid-Bz42mxpd.js';
import { C as Coord, a as PointRelation, P as PointRelationResult, b as Polar } from './PointRelationTypes-DmpkuPjY.js';
import { T as TraversableTree } from './Types-DvArcVMB.js';
import { b as Scaler } from './Scaler-C_gjBH0I.js';
...
declare function apply$3(op: ApplyOp, rect: RectPositioned, width: number, height?: number): RectPositioned;
declare function apply$3(op: ApplyOp, rect: Rect, width: number, height: number): Rect;
declare function apply$3(op: ApplyOp, a: RectPositioned, b: Rect): RectPositioned;
declare function apply$3(op: ApplyOp, a: Rect, b: Rect): Rect;
/**
 ...
 */
declare function divide$3(rect: RectPositioned, width: number, height?: number): RectPositioned;
/**
 ...
 *
 */
declare function divide$3(rect: Rect, width: number, height: number): Rect;
/**
 ...
 * @param b
 */
declare function divide$3(a: RectPositioned, b: Rect): RectPositioned;
/**
 ...
 * @param b
 */
declare function divide$3(a: Rect, b: Rect): Rect;
/**
...
declare function subtract$3(a: RectPositioned, b: Rect): RectPositioned;
/**
 ...
 * @param b
 */
declare function sum$3(a: RectPositioned, b: Rect): RectPositioned;
/**
...
declare const index$7_applyDim: typeof applyDim;
declare const index$7_applyScalar: typeof applyScalar;
...
declare const index$7_divideDim: typeof divideDim;
declare const index$7_divideScalar: typeof divideScalar;
...
declare const index$7_multiplyDim: typeof multiplyDim;
declare const index$7_subtractOffset: typeof subtractOffset;
declare const index$7_sumOffset: typeof sumOffset;
declare namespace index$7 {
  export { type index$7_ApplyOp as ApplyOp, Empty$3 as Empty, index$7_EmptyPositioned as EmptyPositioned, index$7_Rect as Rect, index$7_RectArray as RectArray, index$7_RectPositioned as RectPositioned, index$7_RectPositionedArray as RectPositionedArray, type index$7_RectRandomPointOpts as RectRandomPointOpts, apply$3 as apply, index$7_applyDim as applyDim, index$7_applyScalar as applyScalar, area$4 as area, index$7_cardinal as cardinal, index$7_center as center, corners$1 as corners, index$7_distanceFromCenter as distanceFromCenter, index$7_distanceFromExterior as distanceFromExterior, divide$3 as divide, index$7_divideDim as divideDim, index$7_divideScalar as divideScalar, edges$1 as edges, fromCenter$2 as fromCenter, index$7_fromElement as fromElement, fromNumbers$2 as fromNumbers, index$7_fromTopLeft as fromTopLeft, index$7_getEdgeX as getEdgeX, index$7_getEdgeY as getEdgeY, index$7_getRectPositioned as getRectPositioned, index$7_getRectPositionedParameter as getRectPositionedParameter, guard$4 as guard, index$7_guardDim as guardDim, index$7_guardPositioned as guardPositioned, intersectsPoint$1 as intersectsPoint, isEmpty$3 as isEmpty, isEqual$5 as isEqual, index$7_isEqualSize as isEqualSize, isIntersecting$1 as isIntersecting, isPlaceholder$3 as isPlaceholder, isPositioned$1 as isPositioned, index$7_isRect as isRect, index$7_isRectPositioned as isRectPositioned, lengths$1 as lengths, index$7_maxFromCorners as maxFromCorners, multiply$4 as multiply, index$7_multiplyDim as multiplyDim, multiplyScalar$2 as multiplyScalar, random$1 as random, randomPoint$1 as randomPoint, subtract$3 as subtract, index$7_subtractOffset as subtractOffset, sum$3 as sum, index$7_sumOffset as sumOffset, toArray$1 as toArray };
}
 ...
 * @returns
 */
declare const angleRadian$1: (lineOrPoint: Line | Point, b?: Point) => number;
/**
...
declare function divide$1(a: Point3d, b: Point3d): Point3d;
declare function divide$1(a: Point, x: number, y: number): Point;
declare function divide$1(a: Point3d, x: number, y: number, z: number): Point3d;
declare function divide$1(ax: number, ay: number, bx: number, by: number): Point;
declare function divide$1(ax: number, ay: number, az: number, bx: number, by: number, bz: number): Point3d;
/**
 ...
 * @returns
 */
declare function divider(a: Point3d | Point | number | Array<number>, b?: number, c?: number): (aa: Point3d | Point | number | Array<number>, bb?: number, cc?: number) => Point | Point3d;
...
declare const index$4_compareByY: typeof compareByY;
...
declare const index$4_getTwoPointParameters: typeof getTwoPointParameters;
...
declare const index$4_to2d: typeof to2d;
declare const index$4_to3d: typeof to3d;
...
declare namespace index$4 {
  export { Empty$1 as Empty, Placeholder$2 as Placeholder, index$4_Point as Point, index$4_Point3d as Point3d, index$4_PointRelation as PointRelation, index$4_PointRelationResult as PointRelationResult, index$4_abs as abs, index$4_angleRadian as angleRadian, apply$1 as apply, bbox$3 as bbox, centroid$1 as centroid, index$4_clamp as clamp, clampMagnitude$1 as clampMagnitude, index$4_compare as compare, index$4_compareByX as compareByX, index$4_compareByY as compareByY, index$4_convexHull as convexHull, index$4_distance as distance, index$4_distanceToCenter as distanceToCenter, index$4_distanceToExterior as distanceToExterior, divide$1 as divide, index$4_divider as divider, dotProduct$1 as dotProduct, index$4_findMinimum as findMinimum, index$4_from as from, index$4_fromNumbers as fromNumbers, index$4_getPointParameter as getPointParameter, index$4_getTwoPointParameters as getTwoPointParameters, guard$2 as guard, index$4_guardNonZeroPoint as guardNonZeroPoint, interpolate$2 as interpolate, index$4_invert as invert, isEmpty$1 as isEmpty, isEqual$2 as isEqual, index$4_isNaN as isNaN, index$4_isNull as isNull, isPlaceholder$1 as isPlaceholder, index$4_isPoint as isPoint, index$4_isPoint3d as isPoint3d, index$4_leftmost as leftmost, multiply$2 as multiply, index$4_multiplyScalar as multiplyScalar, normalise$1 as normalise, index$4_normaliseByRect as normaliseByRect, index$4_pipeline as pipeline, index$4_pipelineApply as pipelineApply, index$4_progressBetween as progressBetween, index$4_project as project, index$4_quantiseEvery as quantiseEvery, index$4_random as random, index$4_reduce as reduce, index$4_relation as relation, index$4_rightmost as rightmost, rotate$1 as rotate, index$4_rotatePointArray as rotatePointArray, index$4_round as round, subtract$1 as subtract, sum$1 as sum, index$4_to2d as to2d, index$4_to3d as to3d, index$4_toArray as toArray, index$4_toIntegerValues as toIntegerValues, toString$2 as toString, index$4_withinRange as withinRange, index$4_wrap as wrap };
}
