...
import { P as Path, C as CompoundPath$1, D as Dimensions, W as WithBeziers } from './PathType-9cjB2t-Y.js';
...
import { T as Triangle, Q as QuadraticBezier, C as CubicBezier, a as CubicBezierPath, b as QuadraticBezierPath, c as Arc, A as ArcPositioned, d as Ellipse } from './Ellipse-Cie3ckUe.js';
import { a as RectPositioned, R as Rect, b as RectArray, c as RectPositionedArray } from './RectTypes-BVWwyVKg.js';
import { P as PolyLine, L as Line } from './LineType-DkIFzpdp.js';
import { a as CardinalDirection, b as Cell, G as Grid, C as CellAccessor, V as VisitGenerator, c as Grid$1 } from './Grid-BuHUyKrP.js';
import { C as Coord, a as PointRelation, P as PointRelationResult, b as Polar } from './PointRelationTypes-Dw4GvWQq.js';
import { T as TraversableTree } from './Types-DvArcVMB.js';
import { b as Scaler } from './Scaler-XwDjxOLc.js';
import { R as Rgb } from './Colour-jbiYG85Y.js';
...
declare function apply$3(pt: Point3d, fn: Point3dApplyFn): Point3d;
declare function apply$3(pt: Point, fn: PointApplyFn): Point;
 ...
 */
declare const isEqual$5: (...p: ReadonlyArray<Point>) => boolean;
...
declare const index$7_Empty3d: typeof Empty3d;
declare const index$7_Placeholder3d: typeof Placeholder3d;
declare const index$7_Point: typeof Point;
declare const index$7_Point3d: typeof Point3d;
type index$7_Point3dApplyFn = Point3dApplyFn;
type index$7_PointApplyFn = PointApplyFn;
type index$7_PointAverageKinds = PointAverageKinds;
type index$7_PointAverager = PointAverager;
declare const index$7_PointRelation: typeof PointRelation;
declare const index$7_PointRelationResult: typeof PointRelationResult;
declare const index$7_Unit: typeof Unit;
declare const index$7_Unit3d: typeof Unit3d;
declare const index$7_abs: typeof abs;
declare const index$7_angleRadianCircle: typeof angleRadianCircle;
declare const index$7_averager: typeof averager;
declare const index$7_clamp: typeof clamp;
declare const index$7_compare: typeof compare;
declare const index$7_compareByX: typeof compareByX;
declare const index$7_compareByY: typeof compareByY;
declare const index$7_compareByZ: typeof compareByZ;
declare const index$7_convexHull: typeof convexHull;
declare const index$7_distanceToCenter: typeof distanceToCenter;
declare const index$7_distanceToExterior: typeof distanceToExterior;
declare const index$7_divider: typeof divider;
declare const index$7_findMinimum: typeof findMinimum;
declare const index$7_from: typeof from;
declare const index$7_getTwoPointParameters: typeof getTwoPointParameters;
declare const index$7_guardNonZeroPoint: typeof guardNonZeroPoint;
declare const index$7_invert: typeof invert;
declare const index$7_isNull: typeof isNull;
declare const index$7_isPoint: typeof isPoint;
declare const index$7_isPoint3d: typeof isPoint3d;
declare const index$7_leftmost: typeof leftmost;
declare const index$7_pipeline: typeof pipeline;
declare const index$7_pipelineApply: typeof pipelineApply;
declare const index$7_progressBetween: typeof progressBetween;
declare const index$7_project: typeof project;
declare const index$7_quantiseEvery: typeof quantiseEvery;
declare const index$7_random3d: typeof random3d;
declare const index$7_reduce: typeof reduce;
declare const index$7_relation: typeof relation;
declare const index$7_rightmost: typeof rightmost;
declare const index$7_rotatePointArray: typeof rotatePointArray;
declare const index$7_round: typeof round;
declare const index$7_to2d: typeof to2d;
declare const index$7_to3d: typeof to3d;
declare const index$7_toIntegerValues: typeof toIntegerValues;
declare const index$7_wrap: typeof wrap;
declare namespace index$7 {
  export { Empty$3 as Empty, index$7_Empty3d as Empty3d, Placeholder$3 as Placeholder, index$7_Placeholder3d as Placeholder3d, index$7_Point as Point, index$7_Point3d as Point3d, type index$7_Point3dApplyFn as Point3dApplyFn, type index$7_PointApplyFn as PointApplyFn, type index$7_PointAverageKinds as PointAverageKinds, type index$7_PointAverager as PointAverager, index$7_PointRelation as PointRelation, index$7_PointRelationResult as PointRelationResult, index$7_Unit as Unit, index$7_Unit3d as Unit3d, index$7_abs as abs, angleRadian$1 as angleRadian, index$7_angleRadianCircle as angleRadianCircle, apply$3 as apply, index$7_averager as averager, bbox$5 as bbox, centroid$1 as centroid, index$7_clamp as clamp, clampMagnitude$1 as clampMagnitude, index$7_compare as compare, index$7_compareByX as compareByX, index$7_compareByY as compareByY, index$7_compareByZ as compareByZ, index$7_convexHull as convexHull, distance$1 as distance, index$7_distanceToCenter as distanceToCenter, index$7_distanceToExterior as distanceToExterior, divide$3 as divide, index$7_divider as divider, dotProduct$1 as dotProduct, index$7_findMinimum as findMinimum, index$7_from as from, fromNumbers$2 as fromNumbers, getPointParameter$1 as getPointParameter, index$7_getTwoPointParameters as getTwoPointParameters, guard$5 as guard, index$7_guardNonZeroPoint as guardNonZeroPoint, interpolate$4 as interpolate, index$7_invert as invert, isEmpty$3 as isEmpty, isEqual$5 as isEqual, isNaN$1 as isNaN, index$7_isNull as isNull, isPlaceholder$3 as isPlaceholder, index$7_isPoint as isPoint, index$7_isPoint3d as isPoint3d, index$7_leftmost as leftmost, multiply$4 as multiply, multiplyScalar$2 as multiplyScalar, normalise$1 as normalise, normaliseByRect$1 as normaliseByRect, index$7_pipeline as pipeline, index$7_pipelineApply as pipelineApply, index$7_progressBetween as progressBetween, index$7_project as project, index$7_quantiseEvery as quantiseEvery, random$2 as random, index$7_random3d as random3d, index$7_reduce as reduce, index$7_relation as relation, index$7_rightmost as rightmost, rotate$2 as rotate, index$7_rotatePointArray as rotatePointArray, index$7_round as round, subtract$3 as subtract, sum$3 as sum, index$7_to2d as to2d, index$7_to3d as to3d, toArray$1 as toArray, index$7_toIntegerValues as toIntegerValues, toString$3 as toString, withinRange$1 as withinRange, index$7_wrap as wrap };
}
...
type ApplyOp = (a: number, b: number) => number;
declare function apply$2(op: ApplyOp, rect: RectPositioned, width: number, height?: number): RectPositioned;
declare function apply$2(op: ApplyOp, rect: Rect, width: number, height: number): Rect;
declare function apply$2(op: ApplyOp, a: RectPositioned, b: Rect): RectPositioned;
declare function apply$2(op: ApplyOp, a: Rect, b: Rect): Rect;
/**
 ...
 * @param param
 */
declare function applyScalar(op: ApplyOp, rect: Rect, param: number): Rect;
/**
 ...
 * @param param
 */
declare function applyScalar(op: ApplyOp, rect: RectPositioned, param: number): RectPositioned;
/**
 ...
 * @returns
 */
declare function applyDim(op: ApplyOp, rect: Rect | RectPositioned, param: number): Rect | RectPositioned;
...
declare namespace index {
  export { index_Arc as Arc, index_ArcPositioned as ArcPositioned, index$2 as Arcs, index$3 as Beziers, index_Circle as Circle, index_CirclePositioned as CirclePositioned, index$5 as Circles, type index_CircularPath as CircularPath, CompoundPath as Compound, CompoundPath$1 as CompoundPath, index_Convolve2d as Convolve2d, index_CurveSimplification as CurveSimplification, index_Dimensions as Dimensions, Ellipse as Ellipses, Grid$1 as Grids, Layout as Layouts, index_Line as Line, index$4 as Lines, index_Path as Path, index$8 as Paths, index_Point as Point, index_Point3d as Point3d, type index_PointCalculableShape as PointCalculableShape, index$7 as Points, index_Polar as Polar, index_PolyLine as PolyLine, index_QuadTree as QuadTree, index_Rect as Rect, index_RectArray as RectArray, index_RectPositioned as RectPositioned, index_RectPositionedArray as RectPositionedArray, index$6 as Rects, index_Scaler as Scaler, type index_ShapePositioned as ShapePositioned, index$9 as Shapes, index_SurfacePoints as SurfacePoints, index_Triangle as Triangle, index$1 as Triangles, type Vector$1 as Vector, Vector as Vectors, Waypoint$1 as Waypoints, index_WithBeziers as WithBeziers, index_degreeArc as degreeArc, index_degreeToRadian as degreeToRadian, index_degreesSum as degreesSum, index_radianArc as radianArc, index_radianInvert as radianInvert, index_radianToDegree as radianToDegree, index_radiansFromAxisX as radiansFromAxisX, index_radiansSum as radiansSum };
}

export { CompoundPath as C, Layout as L, type PointCalculableShape as P, QuadTree as Q, SurfacePoints as S, Vector as V, Waypoint$1 as W, index$5 as a, index$4 as b, index$6 as c, index$7 as d, index$8 as e, index$3 as f, CurveSimplification as g, Convolve2d as h, index as i, index$2 as j, index$9 as k, index$1 as l, type Vector$1 as m, type CircularPath as n, type ShapePositioned as o, degreeToRadian as p, radianToDegree as q, radianInvert as r, radiansFromAxisX as s, radiansSum as t, degreesSum as u, radianArc as v, degreeArc as w };
