...
import { Interval$1 as Interval } from "./types.d-BvIm-IgD.js";
import { SimpleEventEmitter$3 as SimpleEventEmitter } from "./simple-event-emitter.d-maTML2ek.js";
import { Point } from "./point-type.d-B4aM6DiI.js";
import { Rect } from "./rect-types.d-DrUTnJmE.js";
import { RandomSource$1 as RandomSource } from "./types.d-DL4jgZhc.js";
import { Path } from "./path-type.d-kUiO-Pgj.js";
import { EasingName, EasingOptions, EasingTickOptions, EasingTimeOptions, ModSettable, ModSettableFeedback, ModSettableOptions, ModSource, ModulationFunction, ModulatorTimed, SpringOptions, index_d_exports$22 as index_d_exports } from "./index.d-CEM7keh7.js";
import { BasicInterpolateOptions$1 as BasicInterpolateOptions } from "./interpolate.d-BH1ke4z8.js";

//#region ../packages/modulation/dist/src/envelope/Types.d.ts
...
type AdsrStateTransitions = Readonly<typeof adsrStateTransitions>; //#endregion
//#region ../packages/modulation/dist/src/envelope/AdsrBase.d.ts
...
//#region ../packages/modulation/dist/src/envelope/Adsr.d.ts
...
//#endregion
//#region ../packages/modulation/dist/src/envelope/index.d.ts
...
//#endregion
//#region ../packages/modulation/dist/src/source/ticks.d.ts
...
//#endregion
//#region ../packages/modulation/dist/src/source/time.d.ts
/**
...
//#endregion
//#region ../packages/modulation/dist/src/source/per-second.d.ts
/**
...
//#endregion
//#region ../packages/modulation/dist/src/source/index.d.ts
declare namespace index_d_exports$1 {
  export { TicksModSettableOptions, bpm, elapsed, hertz, perMinute, perSecond, ticks$1 as ticks };
}
//#endregion
//#region ../packages/modulation/dist/src/cubic-bezier.d.ts
/**
...
* @returns Value
*/
declare const cubicBezierShape: (b: number, d: number) => ModulationFunction;

//#endregion
//#region ../packages/modulation/dist/src/drift.d.ts
type Drifter = {
...
//#endregion
//#region ../packages/modulation/dist/src/forces.d.ts
...
//#endregion
//#region ../packages/modulation/dist/src/gaussian.d.ts
/**
...
//#endregion
//#region ../packages/modulation/dist/src/interpolate.d.ts
/**
...
//#endregion
//#region ../packages/modulation/dist/src/jitter.d.ts
type JitterOpts = {
...
//#endregion
//#region ../packages/modulation/dist/src/mix.d.ts
/**
...
*/
declare const mixModulators: (balance: number, a: ModulationFunction, b: ModulationFunction) => ModulationFunction;
...
* @returns Numeric value
*/
declare const crossfade: (a: ModulationFunction, b: ModulationFunction) => ModulationFunction;

//#endregion
//#region ../packages/modulation/dist/src/modulator-timed.d.ts
/**
...
* @returns
*/
declare const time: (fn: ModulationFunction, duration: Interval) => () => number;
...
*/
declare const timeModulator: (fn: ModulationFunction, duration: Interval) => ModulatorTimed;
...
* @returns
*/
declare const ticks: (fn: ModulationFunction, totalTicks: number) => () => number;
...
* @returns ModulatorTimed
*/
declare const tickModulator: (fn: ModulationFunction, durationTicks: number) => ModulatorTimed;

//#endregion
//#region ../packages/modulation/dist/src/no-op.d.ts
/**
...
* @returns
*/
declare const noop: ModulationFunction;
...
//#endregion
//#region ../packages/modulation/dist/src/oscillator.d.ts
...
//#endregion
//#region ../packages/modulation/dist/src/ping-pong.d.ts
/**
...
//#endregion
//#region ../packages/modulation/dist/src/spring.d.ts
/**
...
* @returns
*/
declare const springShape: (opts?: SpringOptions) => ModulationFunction;

//#endregion
//#region ../packages/modulation/dist/src/timing-source-factory.d.ts
...
//#endregion
//#region ../packages/modulation/dist/src/waveforms.d.ts
...
* @returns
*/
declare function triangleShape(period?: number): ModulationFunction;
...
* @returns
*/
declare function squareShape(period?: number): ModulationFunction;
...
* @returns
*/
declare function sineShape(period?: number): ModulationFunction;
...
* @returns
*/
declare function arcShape(period?: number): ModulationFunction;
declare function sineBipolarShape(period?: number): ModulationFunction;
...
* @returns
*/
declare function waveFromSource(sourceFunction: ModSettable, shaperFunction: ModulationFunction, invert?: boolean): WaveModulator;

//#endregion
//#region ../packages/modulation/dist/src/weighted-average.d.ts
/**
* Weighted average
*
* @param currentValue
...
//#endregion
//#region ../packages/modulation/dist/src/weighted-random.d.ts
/**
...
//#endregion
//#region src/modulation.d.ts
declare namespace modulation_d_exports {
  export { Drifter, EasingName, EasingOptions, EasingTickOptions, EasingTimeOptions, index_d_exports as Easings, index_d_exports$2 as Envelopes, forces_d_exports as Forces, InterpolateOptions, JitterOpts, Jitterer, ModSettable, ModSettableFeedback, ModSettableOptions, ModSource, index_d_exports$2 as Modulation, ModulationFunction, ModulatorTimed, oscillator_d_exports as Oscillators, index_d_exports$1 as Source, index_d_exports$1 as Sources, SpringOptions, TimingSourceFactory, TimingSources, WaveModulator, WaveOptions, WaveShaperFeedback, Waveforms, WeightedOptions, arcShape, crossfade, cubicBezierShape, drift, gaussian, interpolate, interpolateAngle, interpolatorInterval, interpolatorStepped, jitter, jitterAbsolute, mix, mixModulators, noop, pingPong, pingPongPercent, sineBipolarShape, sineShape, spring, springShape, springValue, squareShape, tickModulator, ticks, time, timeModulator, timingSourceFactory, triangleShape, wave, waveFromSource, weighted, weightedAverage, weightedSource };
}
//#endregion
export { Drifter, InterpolateOptions, JitterOpts, Jitterer, TimingSourceFactory, TimingSources, WaveModulator, WaveOptions, WaveShaperFeedback, Waveforms, WeightedOptions as WeightedOptions$1, arcShape as arcShape$1, crossfade as crossfade$1, cubicBezierShape as cubicBezierShape$1, drift as drift$1, forces_d_exports, gaussian as gaussian$2, index_d_exports$1 as index_d_exports$20, index_d_exports$2 as index_d_exports$21, interpolate as interpolate$5, interpolateAngle as interpolateAngle$3, interpolatorInterval as interpolatorInterval$1, interpolatorStepped as interpolatorStepped$3, jitter as jitter$1, jitterAbsolute as jitterAbsolute$1, mix as mix$1, mixModulators as mixModulators$1, modulation_d_exports, noop as noop$1, oscillator_d_exports, pingPong as pingPong$1, pingPongPercent as pingPongPercent$1, sineBipolarShape as sineBipolarShape$1, sineShape as sineShape$1, spring as spring$1, springShape as springShape$1, springValue as springValue$1, squareShape as squareShape$1, tickModulator, ticks, time, timeModulator, timingSourceFactory as timingSourceFactory$1, triangleShape as triangleShape$1, wave as wave$1, waveFromSource as waveFromSource$1, weighted as weighted$3, weightedAverage as weightedAverage$1, weightedSource as weightedSource$3 };
//# sourceMappingURL=modulation.d-CwzOkLSy.d.ts.map