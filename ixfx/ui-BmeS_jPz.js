...
import { compareData, getField, getPathsAndData, updateByPath } from "./records-C4EGf9mW.js";
import { afterMatch, beforeMatch, stringSegmentsWholeToEnd, stringSegmentsWholeToFirst, wildcard } from "./text-D_AxRnHp.js";
import { isEqualContextString$1 as isEqualContextString } from "./is-equal-BLmzsdF3.js";
import { continuously$1 as continuously } from "./continuously-DDI0Kqes.js";
import { elapsedInterval$1 as elapsedInterval } from "./elapsed-v115azy4.js";
import { intervalToMs$1 as intervalToMs } from "./interval-type-BXX22LYH.js";
import { getErrorMessage$4 as getErrorMessage } from "./src-I4YYy_WW.js";
import { throwResult$1 as throwResult } from "./results-CYb8QUaj.js";
import { sleep$1 as sleep } from "./sleep-BtCb2Q0X.js";
import { isAsyncIterable$2 as isAsyncIterable, isIterable$2 as isIterable, nextWithTimeout } from "./src-BpVXqMRv.js";
import { init, to$2 as to } from "./state-machine-D0z-LEtt.js";
import { getFromKeys } from "./maps-D3vsLEyl.js";
import { QueueMutable$2 as QueueMutable } from "./queue-mutable-BNQFu7n3.js";
import { DispatchList$2 as DispatchList } from "./dispatch-list-5GN8t8ns.js";
import { timeout$2 as timeout } from "./timeout-D6iY0vk7.js";
import { resolveEl$2 as resolveEl } from "./resolve-el-DypACrB4.js";
import { HslSpace, SrgbSpace, toColour, toCssColour } from "./conversion-zy5801Pn.js";
...
function domHslInputValue(targetOrQuery, options = {}) {
	...
	const rx = transform(input, (v) => {
		return HslSpace.fromCssScalar(v, { ensureSafe: true });
	});
	return {
		...rx,
		last() {
			return HslSpace.fromCssScalar(input.last(), { ensureSafe: true });
		},
		set(value) {
			input.set(HslSpace.toCss(value));
		}
	};
}
/**
	...
	const readValue = () => {
		...
		for (const [k, v] of fd.entries()) {
			...
			if (typeHint === `number`) entries.push([k, Number.parseFloat(vString)]);
				...
				entries.push([k, SrgbSpace.fromCss(vRgb)]);
...
const elements = (source, options) => {
	...
	const findBind = (path) => {
		const bind$1 = getFromKeys(binds, stringSegmentsWholeToEnd(path));
...
//#region src/ui.ts
var ui_exports = {};
__export(ui_exports, { Rx: () => rx_exports });

//#endregion
export { rx_exports as rx_exports$1, ui_exports };
//# sourceMappingURL=ui-BmeS_jPz.js.map