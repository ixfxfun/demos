...
var create = (pathOpts = {}) => {
  ...
  return { getRoot: getRoot2, add, prettyPrint, remove: remove2, getValue, getValues, hasPath, childrenLength: childrenLength2, getNode, clearValues };
};
...
function findChildByValue(parent, possibleValue, eq = isEqualDefault, maxDepth = 0) {
  ...
  for (const d of breadthFirst(parent, maxDepth)) {
    if (isTraver) {
      ...
      if (eq(d.value, possibleValue)) return d;
    }
  }
  return;
}
...
//# sourceMappingURL=chunk-QJJ6YNP3.js.map