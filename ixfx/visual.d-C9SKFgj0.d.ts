...
import { Point, Rect, RectPositioned } from "./rect-types.d-DANFJL1v.js";
...
declare const toCssColour: (colour: Colourish) => string;
declare const fromCssColour: (colour: string) => Colour;
declare const guard: (colour: Colour) => void;
declare const toColour: (colourish: Colourish) => Colour;
...
declare const HslSpace: {
  ...
  fromCss: (value: string) => HslAbsolute;
  toCss: (hsl: Hsl) => string;
  toLibrary: (hsl: Hsl) => HSL;
  fromLibrary: (hsl: HSL) => HslAbsolute;
  guard: (hsl: Hsl) => void;
...
declare namespace index_d_exports {
  export { Colour, Colourish, Hsl, HslAbsolute, HslBase, HslScalar, HslSpace, LchBase, OkLch, OkLchAbsolute, OkLchBase, OkLchScalar, Rgb, Rgb8Bit, RgbBase, RgbScalar, SrgbSpace as RgbSpace, fromCssColour, goldenAngleColour, guard, multiplyOpacity, randomHue, toColour, toCssColour, toStringFirst, withOpacity };
}
...
//#endregion
export { CanvasEvents, CanvasHelper as CanvasHelper$1, CanvasHelperOptions, Opts, image_data_grid_d_exports, index_d_exports as index_d_exports$11, pointerVisualise as pointerVisualise$1, video_d_exports, visual_d_exports };
//# sourceMappingURL=visual.d-C9SKFgj0.d.ts.map