...
import { N as NumberFunction } from './Types-DaSeYFCm.js';
import { I as InterpolateOptions, i as interpolate, a as interpolateAngle, b as interpolatorInterval, c as interpolatorStepped, p as piPi } from './Interpolate-Doc6ee_I.js';
import { m as minMaxAvg } from './MinMaxAvg-BdRIkRjw.js';
import { I as Interval } from './IntervalType-B4PbUkjV.js';
import { N as NumberScaler, b as NumberScalerTwoWay, M as MinMaxAvgOpts, a as MinMaxAvgTotal } from './Types-D1-qcE-Y.js';
...
type index_DifferenceKind = DifferenceKind;
declare const index_InterpolateOptions: typeof InterpolateOptions;
...
declare const index_NumberScaler: typeof NumberScaler;
declare const index_NumberScalerTwoWay: typeof NumberScalerTwoWay;
...
declare const index_clamper: typeof clamper;
declare const index_count: typeof count;
declare const index_differenceFromFixed: typeof differenceFromFixed;
declare const index_differenceFromLast: typeof differenceFromLast;
declare const index_dotProduct: typeof dotProduct;
declare const index_filterIterable: typeof filterIterable;
...
declare const index_rangeInclusive: typeof rangeInclusive;
...
declare const index_scalerNull: typeof scalerNull;
declare const index_scalerPercent: typeof scalerPercent;
declare const index_scalerTwoWay: typeof scalerTwoWay;
declare const index_softmax: typeof softmax;
declare const index_thresholdAtLeast: typeof thresholdAtLeast;
...
declare namespace index {
  export { index_Bipolar as Bipolar, type index_DifferenceKind as DifferenceKind, index_InterpolateOptions as InterpolateOptions, index_MinMaxAvgOpts as MinMaxAvgOpts, index_MinMaxAvgTotal as MinMaxAvgTotal, type index_MovingAverageTimedOptions as MovingAverageTimedOptions, index_Normalise as Normalise, index_NumberScaler as NumberScaler, index_NumberScalerTwoWay as NumberScalerTwoWay, index_applyToValues as applyToValues, index_average as average, index_averageWeighted as averageWeighted, index_clamp as clamp, index_clampIndex as clampIndex, index_clamper as clamper, index_count as count, index_differenceFromFixed as differenceFromFixed, index_differenceFromLast as differenceFromLast, index_dotProduct as dotProduct, index_filterIterable as filterIterable, index_flip as flip, index_interpolate as interpolate, index_interpolateAngle as interpolateAngle, index_interpolatorInterval as interpolatorInterval, index_interpolatorStepped as interpolatorStepped, index_isApprox as isApprox, index_isValid as isValid, index_linearSpace as linearSpace, index_max as max, index_maxFast as maxFast, index_maxIndex as maxIndex, index_min as min, index_minFast as minFast, index_minIndex as minIndex, index_minMaxAvg as minMaxAvg, index_movingAverage as movingAverage, index_movingAverageLight as movingAverageLight, index_movingAverageTimed as movingAverageTimed, index_noiseFilter as noiseFilter, index_numericPercent as numericPercent, index_numericRange as numericRange, index_numericRangeRaw as numericRangeRaw, index_piPi as piPi, index_proportion as proportion, index_quantiseEvery as quantiseEvery, index_rangeInclusive as rangeInclusive, index_round as round, index_scale as scale, index_scaleClamped as scaleClamped, index_scalePercent as scalePercent, index_scalePercentages as scalePercentages, index_scaler as scaler, index_scalerNull as scalerNull, index_scalerPercent as scalerPercent, index_scalerTwoWay as scalerTwoWay, index_softmax as softmax, index_thresholdAtLeast as thresholdAtLeast, index_total as total, index_totalFast as totalFast, index_validNumbers as validNumbers, index_weight as weight, index_wrap as wrap, index_wrapInteger as wrapInteger, index_wrapRange as wrapRange };
}

export { wrapRange as $, maxIndex as A, Bipolar as B, minIndex as C, max as D, total as E, maxFast as F, totalFast as G, minFast as H, proportion as I, quantiseEvery as J, type DifferenceKind as K, differenceFromFixed as L, type MovingAverageTimedOptions as M, Normalise as N, differenceFromLast as O, round as P, scale as Q, scaler as R, scalerNull as S, scaleClamped as T, scalePercentages as U, scalePercent as V, scalerPercent as W, scalerTwoWay as X, softmax as Y, wrapInteger as Z, wrap as _, applyToValues as a, averageWeighted as b, clamp as c, clamper as d, clampIndex as e, count as f, filterIterable as g, flip as h, index as i, numericRange as j, numericPercent as k, isValid as l, isApprox as m, numericRangeRaw as n, linearSpace as o, movingAverageLight as p, movingAverageTimed as q, rangeInclusive as r, movingAverage as s, thresholdAtLeast as t, noiseFilter as u, validNumbers as v, weight as w, dotProduct as x, average as y, min as z };
