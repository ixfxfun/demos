...
import { isEqualValueDefault$3 as isEqualValueDefault } from "./is-equal-DWRSOMvL.js";
import { interpolate$6 as interpolate } from "./interpolate-Cvxo2tVw.js";
import { scale$2 as scale, scaler$4 as scaler } from "./scale-D4tnfavu.js";
...
//#endregion
//#region ../packages/numbers/dist/src/count.js
/**
...
//#endregion
//#region ../packages/numbers/dist/src/generate.js
/**
...
const array = (values, minForced, maxForced) => {
	...
	return values.map((v) => clamp$1(scale$1(v, min$1, max$1)));
};
...
//#endregion
export { HelloTest, applyToValues, array, average, averageWeighted, bipolar_exports, clamp$1 as clamp, clampIndex, clamper, count, differenceFromFixed, differenceFromLast, dotProduct, filterIterable, flip, interpolate$1, interpolateAngle as interpolateAngle$1, interpolatorStepped as interpolatorStepped$1, isApprox, isCloseToAny, isValid, linearSpace, max as max$1, maxFast, maxIndex, min as min$1, minFast, minIndex, movingAverage, movingAverageLight, noiseFilter, numberArrayCompute, numbers_exports, numericPercent, numericRange, numericRangeRaw, proportion, quantiseEvery, rangeInclusive, round, scale$1 as scale, scaleClamped, scalePercent, scalePercentages, scaler$1, scalerNull, scalerPercent, scalerTwoWay, softmax, stream, thresholdAtLeast, total, totalFast, validNumbers, weight, wrap, wrapInteger, wrapRange };
//# sourceMappingURL=numbers-BhQY_m_M.js.map