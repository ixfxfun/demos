import {
  fromNumbers
} from "./chunk-IY6QIHMV.js";
import {
  fromLine,
  toCartesian2 as toCartesian
...
// src/visual/svg/Geometry.ts
var lineFromSvgLine = (el) => {
...
var polarRayFromSvgLine = (el, origin) => {
  const l = lineFromSvgLine(el);
  return fromLine(l, origin);
};

// src/visual/svg/Remove.ts
...
//# sourceMappingURL=chunk-ALBZ3JYS.js.map