...
var hslToColorJs = (hsl, safe) => {
  ...
  let opacity = hsl.opacity === void 0 ? 1 : hsl.opacity;
...
var rgbToColorJs = (rgb) => {
  ...
  return rgb.opacity !== void 0 ? new Color(`srgb`, coords, opacity) : new Color(`srgb`, coords);
};
var toString = (colour) => {
  const c4 = resolve(colour);
  return c4.display();
...
//# sourceMappingURL=chunk-MXBHIKA7.js.map