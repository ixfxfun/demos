...
declare namespace SvgElements {
  export { SvgElements_circle as circle, SvgElements_circleUpdate as circleUpdate, SvgElements_grid as grid, SvgElements_group as group, SvgElements_groupUpdate as groupUpdate, SvgElements_line as line, SvgElements_lineUpdate as lineUpdate, SvgElements_path as path, SvgElements_pathUpdate as pathUpdate, SvgElements_text as text, SvgElements_textPath as textPath, SvgElements_textPathUpdate as textPathUpdate, SvgElements_textUpdate as textUpdate };
}
...
declare namespace Svg {
  export { type Svg_CircleDrawingOpts as CircleDrawingOpts, type Svg_DrawingOpts as DrawingOpts, SvgElements as Elements, type Svg_LineDrawingOpts as LineDrawingOpts, type Svg_MarkerDrawingOpts as MarkerDrawingOpts, type Svg_MarkerOpts as MarkerOpts, type Svg_PathDrawingOpts as PathDrawingOpts, type Svg_StrokeOpts as StrokeOpts, type Svg_SvgHelper as SvgHelper, type Svg_TextDrawingOpts as TextDrawingOpts, type Svg_TextPathDrawingOpts as TextPathDrawingOpts, Svg_applyOpts as applyOpts, Svg_applyPathOpts as applyPathOpts, Svg_applyStrokeOpts as applyStrokeOpts, Svg_clear as clear, Svg_createEl as createEl, Svg_createOrResolve as createOrResolve, Svg_getBounds as getBounds, Svg_makeHelper as makeHelper, Svg_remove as remove, Svg_setBounds as setBounds };
}

export { type CircleDrawingOpts as C, type DrawingOpts as D, type LineDrawingOpts as L, type MarkerOpts as M, type PathDrawingOpts as P, Svg as S, type TextDrawingOpts as T, type StrokeOpts as a, type MarkerDrawingOpts as b, type TextPathDrawingOpts as c, createOrResolve as d, clear as e, createEl as f, applyPathOpts as g, applyOpts as h, applyStrokeOpts as i, type SvgHelper as j, getBounds as k, SvgElements as l, makeHelper as m, remove as r, setBounds as s };
