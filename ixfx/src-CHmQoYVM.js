...
import { integerTest, numberTest, percentTest, resultThrow } from "./src-BhN8B7uk.js";
import { clamp, clampIndex, dotProduct, linearSpace, minFast, minIndex, movingAverageLight, quantiseEvery, round, scale, sortByNumericProperty, wrap } from "./src-Cyp-w-xE.js";
import { mutable } from "./src-Ct16kpGA.js";
import { zipKeyValue } from "./maps-CyRBIIF3.js";
import { Bezier, ObjectTracker, TrackedValueMap, randomElement } from "./bezier-BdPT6F7P.js";
...
* @returns
*/
const fromLineCartesian = (line) => subtract$2(line.b, line.a);
/**
...
//#endregion
export { Empty, Empty$1, EmptyPositioned, Placeholder$3 as Placeholder, PlaceholderPositioned, PointsTracker, Unit, abs, angleConvert, angleParse, angleRadian, applyFields, cardinal, clampMagnitude, compare, corners$1 as corners, cubic, distance, divide$2 as divide, getEdgeX, getEdgeY, getPointParameter, guard$3 as guard, guard$1, indexFromCell, interpolate$4 as interpolate, interpolator, invert, isCubicBezier, isEqual$3 as isEqual, isLine, isPlaceholder$3 as isPlaceholder, isPlaceholder as isPlaceholder$1, isQuadraticBezier, multiply$2 as multiply, multiplyScalar, multiplyScalar$1, normalise, pipeline, pipelineApply, quadraticSimple, rows, scaler, src_exports, subtract$2 as subtract, sum$1 as sum, toCartesian, toPath$1 as toPath };
//# sourceMappingURL=src-CHmQoYVM.js.map