...
import { integerTest$2 as integerTest, numberTest$2 as numberTest, percentTest$2 as percentTest, resultThrow$2 as resultThrow } from "./numbers-DtsSfeyJ.js";
import { arrayTest$2 as arrayTest } from "./arrays-B4Cx2zOC.js";
import { defaultKeyer$1 as defaultKeyer } from "./default-keyer-DZ3sc9FZ.js";
import { SimpleEventEmitter$2 as SimpleEventEmitter } from "./simple-event-emitter-BO1aKc_O.js";
import { dotProduct$2 as dotProduct, minFast$2 as minFast, minIndex$2 as minIndex } from "./numeric-arrays-BoDjja2z.js";
import { clamp$2 as clamp, clampIndex$2 as clampIndex } from "./clamp-DGgSMyUC.js";
import { scale$2 as scale, wrap$4 as wrap } from "./scale-Dj5joIDx.js";
import { movingAverageLight$2 as movingAverageLight } from "./moving-average-Xeg2OVwa.js";
import { zipKeyValue } from "./maps-BuyM6BvP.js";
import { TrackedValueMap } from "./tracker-base-whSvJVNA.js";
import { ObjectTracker } from "./object-tracker-BzehmI5L.js";
import { Bezier } from "./bezier-DKlW4fHe.js";
...
* @returns
*/
const clampMagnitude$1 = (pt, max = 1, min = 0) => {
...
* @returns
*/
const clampMagnitude = (v, max = 1, min = 0) => {
	if (isPolar(v)) return clampMagnitude$2(v, max, min);
	else if (isCartesian(v)) return clampMagnitude$1(v, max, min);
...
* @returns
*/
const interpolate$2 = (circle, t) => pointOnPerimeter(circle, t * piPi$1);
...
const toPath$2 = (circle) => {
	...
	return {
		...
		interpolate: (t) => interpolate$2(circle, t),
		bbox: () => bbox$3(circle),
...
* @returns
*/
const interpolate$1 = (paths, t, useWidth, dimensions) => {
...
const fromPaths = (...paths) => {
	...
	return Object.freeze({
		...
		interpolate: (t, useWidth = false) => interpolate$1(paths, t, useWidth, dims),
...
const distanceFromPointToLine = (p, index, index_) => {
	...
	if (t < 0) return distance$1(p, index);
	if (t > 1) return distance$1(p, index_);
	return distance$1(p, {
...
const area$3 = (t) => {
	guard$1(t, `t`);
	const lengths$2 = edges(t).map((l) => length$3(l));
...
//#endregion
export { arc_exports, bezier_exports, circle_exports, compound_path_exports, curve_simplification_exports, degreeArc, degreeToRadian, degreesSum, ellipse_exports, geometry_exports, grid_exports, layout_exports, line_exports, path_exports, point_exports, polar_exports, quad_tree_exports, radianArc, radianInvert, radianToDegree, radiansFromAxisX, radiansSum, rect_exports, scaler, shape_exports, surface_points_exports, triangle_exports, vector_exports, waypoint_exports };
//# sourceMappingURL=geometry-CuLxap3J.js.map