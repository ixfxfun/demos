import { a as CanvasEvents, C as CanvasHelper, b as CanvasHelperOptions, E as ElementResizeLogic, c as ElementSizer, d as ElementSizerOptions } from './CanvasHelper-B8KYtGGK.js';
import { a as RectPositioned } from './RectTypes-CjvCxMc4.js';
import { R as Result } from './Results-ByWkmocN.js';
import { I as Interval } from './IntervalType-B4PbUkjV.js';
import { k as Reactive } from './Types-ZTmH-4jX.js';
import { P as Point, a as Point3d } from './PointType-BDlA07rn.js';
import { F as Forms } from './Forms-BnDy_H4r.js';
import { c as GridCardinalDirection } from './Types-Dczm1x8S.js';
 ...
 * @returns
 */
declare const getComputedPixels: <T extends ReadonlyArray<keyof CSSStyleDeclaration>>(elOrQuery: HTMLElement | string, ...properties: T) => ComputedPixelsMap<T>;
/**
...
declare const index_CanvasHelperOptions: typeof CanvasHelperOptions;
...
declare const index_getBoundingClientRectWithBorder: typeof getBoundingClientRectWithBorder;
declare const index_getComputedPixels: typeof getComputedPixels;
...
declare const index_resolveElementTry: typeof resolveElementTry;
...
declare namespace index {
  export { index_CanvasEvents as CanvasEvents, index_CanvasHelper as CanvasHelper, index_CanvasHelperOptions as CanvasHelperOptions, type index_CreateUpdateElement as CreateUpdateElement, index_DataDisplay as DataDisplay, type index_DataDisplayOptions as DataDisplayOptions, DataTable$1 as DataTable, index_DragDrop as DragDrop, type index_ElPositionOpts as ElPositionOpts, type index_ElementQueryOptions as ElementQueryOptions, index_ElementResizeLogic as ElementResizeLogic, index_ElementSizer as ElementSizer, index_ElementSizerOptions as ElementSizerOptions, index_Forms as Forms, type index_InlineConsoleOptions as InlineConsoleOptions, type index_Log as Log, type index_LogOpts as LogOpts, type index_Opts as Opts, type index_Panel as Panel, type index_PointSpaces as PointSpaces, type index_QueryOrElements as QueryOrElements, DomRx as Rx, CssVariables as Variables, index_byId as byId, index_cardinalPosition as cardinalPosition, index_clear as clear, index_copyToClipboard as copyToClipboard, index_createAfter as createAfter, index_createIn as createIn, index_cycleCssClass as cycleCssClass, index_defaultErrorHandler as defaultErrorHandler, index_el as el, index_elRequery as elRequery, index_getBoundingClientRectWithBorder as getBoundingClientRectWithBorder, index_getComputedPixels as getComputedPixels, index_getTranslation as getTranslation, index_inlineConsole as inlineConsole, index_insertSorted as insertSorted, index_log as log, index_pointScaler as pointScaler, index_pointerVisualise as pointerVisualise, index_positionFn as positionFn, index_positionFromMiddle as positionFromMiddle, index_positionRelative as positionRelative, index_query as query, index_reconcileChildren as reconcileChildren, index_resolveEl as resolveEl, index_resolveElementTry as resolveElementTry, index_resolveEls as resolveEls, index_setCssClass as setCssClass, index_setCssDisplay as setCssDisplay, index_setCssToggle as setCssToggle, index_setHtml as setHtml, index_setProperty as setProperty, index_setText as setText, index_tabSet as tabSet, index_viewportToSpace as viewportToSpace };
}

export { pointScaler as A, type ElPositionOpts as B, CssVariables as C, DataTable$1 as D, type ElementQueryOptions as E, positionFn as F, cardinalPosition as G, positionRelative as H, type InlineConsoleOptions as I, viewportToSpace as J, positionFromMiddle as K, type LogOpts as L, cycleCssClass as M, getTranslation as N, type Opts as O, type Panel as P, type QueryOrElements as Q, createAfter as R, createIn as S, clear as T, copyToClipboard as U, insertSorted as V, type CreateUpdateElement as W, reconcileChildren as X, byId as Y, DomRx as a, DragDrop as b, getComputedPixels as c, setCssToggle as d, setCssDisplay as e, type DataDisplayOptions as f, getBoundingClientRectWithBorder as g, DataDisplay as h, index as i, el as j, elRequery as k, defaultErrorHandler as l, inlineConsole as m, type Log as n, log as o, pointerVisualise as p, query as q, resolveEl as r, setCssClass as s, resolveElementTry as t, resolveEls as u, setText as v, setHtml as w, setProperty as x, tabSet as y, type PointSpaces as z };
