...
import { G as Grid, g as GridCell, h as GridBoundsLogic, b as GridCellAccessor, c as GridCellSetter, i as GridArray1d, e as GridReadable, d as GridWritable, f as GridCardinalDirection, j as GridNeighbours, k as GridCardinalDirectionOptional, l as GridCellAndValue, m as GridVisual, n as GridNeighbour, o as GridNeighbourSelectionLogic, p as GridVisitorOpts, q as GridCreateVisitor, r as GridIdentifyNeighbours, s as GridNeighbourMaybe, t as GridNeighbourSelector, u as Scaler } from './Scaler-DTFJSZYG.js';
...
import { R as Rgb8Bit } from './Colour-B5L3H-HQ.js';
...
type index$c_ArrowOpts = ArrowOpts;
type index$c_ContainsResult = ContainsResult;
type index$c_PointCalculableShape = PointCalculableShape;
type index$c_ShapePositioned = ShapePositioned;
type index$c_ShapeRandomPointOpts = ShapeRandomPointOpts;
type index$c_Sphere = Sphere;
declare const index$c_arrow: typeof arrow;
declare const index$c_starburst: typeof starburst;
declare namespace index$c {
  export { type index$c_ArrowOpts as ArrowOpts, type index$c_ContainsResult as ContainsResult, type index$c_PointCalculableShape as PointCalculableShape, type index$c_ShapePositioned as ShapePositioned, type index$c_ShapeRandomPointOpts as ShapeRandomPointOpts, type index$c_Sphere as Sphere, index$c_arrow as arrow, center$2 as center, isIntersecting$2 as isIntersecting, randomPoint$2 as randomPoint, index$c_starburst as starburst };
}
 ...
 * @param wrap
 */
declare function cellValues<T>(grid: GridReadable<T>, start?: GridCell, wrap?: boolean): Generator<T, void, unknown>;
/**
 ...
 * @returns
 */
declare const create: (type: VisitorTypes, opts?: Partial<GridVisitorOpts>) => (grid: Grid, optionsOverride?: Partial<GridVisitorOpts>) => Generator<GridCell, any, unknown>;
declare const withLogic: (logic: GridNeighbourSelectionLogic, options?: Partial<GridVisitorOpts>) => (grid: Grid, optionsOverride?: Partial<GridVisitorOpts>) => Generator<GridCell, any, unknown>;
 ...
 * @param image
 */
declare function convolveImage(kernel: Kernel<number>, image: ImageData): Generator<GridCellAndValue<Rgb8Bit>, void, undefined>;
