...
import { t as ISetMutable } from "./ISetMutable-UoIwW5XP.js";
import { i as Point3d, n as Placeholder3d, r as Point, t as Placeholder$1 } from "./point-type-D6AGv-lh.js";
import { a as averager, i as average, n as PointAverager, r as PointAveragerKinds, t as PointAverageKinds } from "./averager-D6GJVyD3.js";
import { a as RectPositioned, i as RectArray, n as Rect3d, o as RectPositionedArray, r as Rect3dPositioned, t as Rect } from "./rect-types-CZBf-fvk.js";
import { a as RandomSource } from "./types-DVhUnHAs.js";
import { a as TimestampedObject, c as TrimReason, n as ObjectTracker, s as TrackedValueOpts, t as TrackedValueMap } from "./tracked-value-CTTcu7tM.js";
...
declare function applyBoundsUniform<T extends GridBoundsLogic>(grid: UniformGrid, cell: GridCell, wrap?: T): GridCell | undefined;
/**
 ...
 * @param wrap
 */
declare function applyBoundsJagged<T extends GridBoundsLogic>(grid: JaggedGrid, cell: GridCell, wrap?: T): GridCell | undefined;
...
declare namespace as_d_exports {
  export { columns, getMaxColumnLength, rows };
}
/**
 ...
 * @param start
 */
declare function rows(grid: Grid, start?: GridCell): Generator<GridCell[], void, unknown>;
/**
...
declare function withLogic(logic: GridNeighbourSelectionLogic, options?: Partial<GridVisitorOpts>): (grid: Grid, optionsOverride?: Partial<GridVisitorOpts>) => Generator<GridCell>;
declare namespace index_d_exports$1 {
  export { array_1d_d_exports as Array1d, array_2d_d_exports as Array2d, as_d_exports as As, index_d_exports$3 as By, CellPlaceholder, Grid, GridArray1d, GridBoundsLogic, GridCardinalDirection, GridCardinalDirectionOptional, GridCell, GridCellAccessor, GridCellAndValue, GridCellSetter, GridCreateVisitor, GridIdentifyNeighbours, GridNeighbour, GridNeighbourMaybe, GridNeighbourSelectionLogic, GridNeighbourSelector, GridNeighbours, GridReadable, GridVisitorOpts, GridVisual, GridWritable, JaggedGrid, UniformGrid, index_d_exports$2 as Visit, allDirections, applyBounds, applyBoundsJagged, applyBoundsUniform, asRectangles, cellAtPoint, cellEquals, cellFromIndexJagged, cellFromIndexUniform, cellKeyString, cellMiddle, crossDirections, firstCellColumnwise, getLine, getVectorFromCardinal, gridString, guardCell_, indexFromCell, indexFromCellJagged, indexFromCellUniform, inside, isCell, isEqual$1 as isEqual, isJaggedGrid, isPlaceholderCell, lastCellColumnwise, lastCellRowwise, neighbourList, neighbours, offset, offsetCardinals, randomNeighbour, rectangleForCell, simpleLine, testCell, testGrid, testJaggedGrid, testUniformGrid, toArray2d, values };
}
//#endregion
...
//#endregion
export { UserPointerTracker as A, index_d_exports$6 as B, JaggedGrid as C, PointTracker as D, PointTrack as E, PolarRay as F, ShapePositioned as G, Triangle as H, PolarRayWithOrigin as I, PolyLine as J, Sphere as K, PolarToCartesian as L, index_d_exports$5 as M, Coord as N, PointTrackerResults as O, PolarLine as P, CircleToSvg as Q, PointRelation as R, GridWritable as S, index_d_exports$4 as T, ContainsResult as U, BarycentricCoord as V, PointCalculableShape as W, CirclePositioned as X, Circle as Y, CircleRandomPointOpts as Z, GridNeighbourSelector as _, GridBoundsLogic as a, GridVisitorOpts as b, GridCell as c, GridCellSetter as d, GridCreateVisitor as f, GridNeighbourSelectionLogic as g, GridNeighbourMaybe as h, GridArray1d as i, UserPointersTracker as j, PointsTracker as k, GridCellAccessor as l, GridNeighbour as m, index_d_exports$1 as n, GridCardinalDirection as o, GridIdentifyNeighbours as p, Line as q, Grid as r, GridCardinalDirectionOptional as s, index_d_exports as t, GridCellAndValue as u, GridNeighbours as v, UniformGrid as w, GridVisual as x, GridReadable as y, PointRelationResult as z };