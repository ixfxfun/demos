import { C as CellAccessor } from './Grid-BuHUyKrP.js';
import { R as Rgb, a as Colour } from './Colour-jbiYG85Y.js';
import { a as Drawing } from './Drawing-DX_48Ltm.js';
 ...
 * @param image
 */
declare function byRow(image: ImageData): Generator<Rgb[], void, unknown>;
/**
 * Yields pixels of an image column by column
 * @param image
 */
declare function byColumn(image: ImageData): Generator<Rgb[], void, unknown>;
...
declare namespace ImageDataGrid {
  export { ImageDataGrid_accessor as accessor, ImageDataGrid_byColumn as byColumn, ImageDataGrid_byRow as byRow };
}
...
declare class CartesianCanvasPlot {
    ...
    renderArea: RectPositioned & {
        dimensionMin: number;
    };
    margin: number;
    constructor(domQueryOrEl: HTMLCanvasElement | string, data: DataSet<PlotPoint, SeriesMeta>, options?: Partial<CartesianPlotOptions>);
     ...
     * @param by
     */
    positionAt(data: Point, elOrQuery: HTMLElement | string, by: (`middle` | `top-left`) | undefined, relativeToQuery: HTMLElement | string): void;
    /**
...
declare namespace index {
  export { BipolarView$1 as BipolarView, index_CartesianCanvasPlot as CartesianCanvasPlot, index_Colour as Colour, index_Drawing as Drawing, index_ImageDataGrid as ImageDataGrid, Palette$1 as Palette, index$1 as Plot, index_Plot2 as Plot2, index_PlotOld as PlotOld, index_SceneGraph as SceneGraph, index_Svg as Svg, index_Video as Video, index_scaleCanvas as scaleCanvas };
}

export { BipolarView$1 as B, CartesianCanvasPlot as C, ImageDataGrid as I, Palette$1 as P, SceneGraph as S, Plot2 as a, PlotOld as b, index$1 as c, index as i, scaleCanvas as s };
