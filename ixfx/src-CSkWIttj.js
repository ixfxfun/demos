...
//#endregion
//#region ../arrays/dist/src/for-each.js
/**
...
* @returns
*/
const mapWithEmptyFallback = (array$1, fn, fallback) => {
...
const arrayWithContext = (values, minForced, maxForced) => {
	...
	return {
		values: values.map((v) => clamp(scale(v, min$1, max$1))),
		original: values,
		min: min$1,
		max: max$1,
...
//#endregion
//#region ../numbers/dist/src/range.js
/**
...
//#endregion
//#region ../numbers/dist/src/track-simple.js
const trackSimple = () => {
	let count$1 = 0;
	let min$1 = Number.MAX_SAFE_INTEGER;
	let max$1 = Number.MIN_SAFE_INTEGER;
...
//#endregion
export { clamp$1 as clamp, clamp as clamp$1, clampIndex, containsDuplicateInstances, dotProduct, insertAt, interpolate, interpolateAngle, isEqual, linearSpace, mapWithEmptyFallback, max, maxFast, minFast, minIndex, movingAverageLight, numberArrayCompute, pairwise, quantiseEvery, randomElement, remove, round, scale, scaler, scalerTwoWay, shuffle, sortByNumericProperty, src_exports, src_exports$1, totalFast, unique, without, wrap, zip };
//# sourceMappingURL=src-CSkWIttj.js.map