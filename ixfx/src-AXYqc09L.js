...
function transparentize(input, alpha, format) {
	...
	const value = round(clamp$1(opacity(input) - alpha, 0, 1));
...
//#endregion
//#region packages/visual/dist/src/colour/guards.js
const isHsl = (v) => {
	if (typeof v === `object`) {
...
//#endregion
//#region packages/visual/dist/src/colour/utility.js
...
* @returns
*/
function scalar$2(hue = .5, sat = 1, lightness$1 = .5, opacity$1 = 1) {
	const hsl = {
		unit: `scalar`,
		space: `hsl`,
		h: hue,
...
function scalar$1(lightness$1 = .7, chroma$1 = .1, hue = .5, opacity$1 = 1) {
	const lch = {
		unit: `scalar`,
		space: `oklch`,
		l: lightness$1,
...
//#endregion
//#region packages/visual/dist/src/colour/interpolate.js
...
function rgbToHsl(rgb, scalarResult) {
	...
	let s = h;
	const l = h;
	if (max === min) if (scalarResult) return scalar$2(0, 0, 0, opacity$1);
	...
	if (scalarResult) return scalar$2(h / 360, s, l, opacity$1);
...
//#endregion
export { convert$1 as convert, fromCss, fromCss$2 as fromCss$1, hex2hsl, hex2oklch, hex2rgb, hsl2rgb, index_default, manualCapture, multiplyOpacity, oklab2rgb, rgb2hsl, rgb2oklch, src_exports, toColour, toCssColour, toCssString$2 as toCssString };
//# sourceMappingURL=src-AXYqc09L.js.map