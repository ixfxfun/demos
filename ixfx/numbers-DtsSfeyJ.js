//#region ../packages/guards/src/result.js
/**
* If `result` is an error, throws it, otherwise ignored.
* @param result
* @returns
*/
function resultThrow(result) {
	if (resultIsError(result)) throw resultToError(result);
	return true;
}
/**
...
//#endregion
export { integerTest as integerTest$2, numberInclusiveRangeTest as numberInclusiveRangeTest$2, numberTest as numberTest$2, percentTest as percentTest$2, resultThrow as resultThrow$2, resultsCollate as resultsCollate$2 };
//# sourceMappingURL=numbers-DtsSfeyJ.js.map