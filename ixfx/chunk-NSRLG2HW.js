...
function pointAtDistance(line2, distance3, fromA = true) {
  if (!fromA) line2 = reverse(line2);
  const dx = line2.b.x - line2.a.x;
  const dy = line2.b.y - line2.a.y;
  const theta = Math.atan2(dy, dx);
  const xp = distance3 * Math.cos(theta);
  const yp = distance3 * Math.sin(theta);
...
//# sourceMappingURL=chunk-NSRLG2HW.js.map