...
declare const functionTest: (value: unknown, parameterName?: string) => GuardResult;
declare const throwFunctionTest: (value: unknown, parameterName?: string) => void;
...
declare const numberInclusiveRangeTest: (value: number | undefined, min: number, max: number, parameterName?: string) => GuardResult;
 ...
 * @param parameterName
 */
declare const stringTest: (value: unknown, range?: StringGuardRange, parameterName?: string) => GuardResult;
declare const throwStringTest: (value: unknown, range?: StringGuardRange, parameterName?: string) => void;

type guards_StringGuardRange = StringGuardRange;
declare const guards_arrayTest: typeof arrayTest;
declare const guards_defined: typeof defined;
declare const guards_functionTest: typeof functionTest;
...
declare const guards_throwStringTest: typeof throwStringTest;
declare namespace guards {
  export { type guards_StringGuardRange as StringGuardRange, guards_arrayTest as arrayTest, guards_defined as defined, guards_functionTest as functionTest, guards_ifNaN as ifNaN, guards_integerParse as integerParse, guards_integerTest as integerTest, guards_isFunction as isFunction, guards_isPlainObject as isPlainObject, guards_isPlainObjectOrPrimitive as isPlainObjectOrPrimitive, guards_isPowerOfTwo as isPowerOfTwo, guards_isStringArray as isStringArray, guards_nullUndef as nullUndef, guards_numberInclusiveRangeTest as numberInclusiveRangeTest, guards_numberTest as numberTest, guards_percentTest as percentTest, guards_stringTest as stringTest, guards_throwArrayTest as throwArrayTest, guards_throwFromResult as throwFromResult, guards_throwFunctionTest as throwFunctionTest, guards_throwIntegerTest as throwIntegerTest, guards_throwNullUndef as throwNullUndef, guards_throwNumberTest as throwNumberTest, guards_throwPercentTest as throwPercentTest, guards_throwStringTest as throwStringTest };
}

export { throwStringTest as A, type GuardResult as G, type NumberGuardRange as N, type StringGuardRange as S, type GuardResultFail as a, type GuardResultOk as b, arrayTest as c, throwNullUndef as d, defined as e, isFunction as f, guards as g, functionTest as h, isStringArray as i, throwFunctionTest as j, isPowerOfTwo as k, ifNaN as l, integerParse as m, nullUndef as n, numberTest as o, throwNumberTest as p, percentTest as q, throwPercentTest as r, integerTest as s, throwArrayTest as t, throwIntegerTest as u, numberInclusiveRangeTest as v, isPlainObject as w, isPlainObjectOrPrimitive as x, throwFromResult as y, stringTest as z };
