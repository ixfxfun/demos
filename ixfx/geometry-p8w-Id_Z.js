...
import { numberTest, throwIntegerTest, throwNumberTest, throwPercentTest } from "./numbers-BSDDLVnO.js";
import { guardArray } from "./arrays-UYv_9s4b.js";
import { zipKeyValue } from "./maps-BDdFW1EQ.js";
import { defaultKeyer$2 as defaultKeyer } from "./default-keyer-BtnLRnJ-.js";
import { SimpleEventEmitter$2 as SimpleEventEmitter } from "./simple-event-emitter-BGnfRwD5.js";
import { clamp$2 as clamp, clampIndex$2 as clampIndex } from "./clamp-Dz6ciLlE.js";
import { scale$2 as scale, wrap$4 as wrap } from "./scale-DCLEEQNP.js";
import { ObjectTracker, TrackedValueMap } from "./object-tracker-DhcnlJQE.js";
import { Bezier } from "./bezier-C98UkFx4.js";
...
const dotProduct$3 = (values$1) => {
	...
	for (let index = 0; index < length$4; index++) {
		let t = 0;
		for (const [p, value] of values$1.entries()) if (p === 0) t = value[index];
		else t *= value[index];
		r += t;
	}
	return r;
...
//# sourceMappingURL=geometry-p8w-Id_Z.js.map