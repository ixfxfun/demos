...
import { numberTest, throwIntegerTest, throwNumberTest } from "./numbers-BSDDLVnO.js";
import { isEqualValueDefault$3 as isEqualValueDefault } from "./is-equal-1lcOs9Gg.js";
import { scaler$4 as scaler } from "./scale-DCLEEQNP.js";
import { interpolate$6 as interpolate } from "./interpolate-CTwhqCyQ.js";
...
const wrapInteger = (v, min$1 = 0, max$1 = 360) => {
	...
	throwIntegerTest(min$1, void 0, `min`);
	throwIntegerTest(max$1, void 0, `max`);
	if (v === min$1) return min$1;
...
const stream = (minDefault, maxDefault) => {
	...
	throwNumberTest(min$1);
	throwNumberTest(max$1);
	return (v) => {
		throwNumberTest(v);
