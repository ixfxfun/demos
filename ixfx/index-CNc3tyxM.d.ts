 ...
 * @returns
 */
declare const scaler: (inMin: number, inMax: number, outMin?: number, outMax?: number, easing?: (v: number) => number, clamped?: boolean) => ((v: number) => number);
/**
 ...
 * @returns
 */
declare const scalerTwoWay: (inMin: number, inMax: number, outMin?: number, outMax?: number, clamped?: boolean, easing?: (v: number) => number) => ScalerTwoWay;
...
type index_ScalerTwoWay = ScalerTwoWay;
...
declare namespace index {
  export { index_Bipolar as Bipolar, type index_DifferenceKind as DifferenceKind, index_InterpolateOptions as InterpolateOptions, index_MinMaxAvgOpts as MinMaxAvgOpts, index_MinMaxAvgTotal as MinMaxAvgTotal, type index_MovingAverageTimedOptions as MovingAverageTimedOptions, index_Normalise as Normalise, type index_ScalerTwoWay as ScalerTwoWay, index_applyToValues as applyToValues, index_average as average, index_averageWeighted as averageWeighted, index_clamp as clamp, index_clampIndex as clampIndex, index_clamper as clamper, index_count as count, index_differenceFromFixed as differenceFromFixed, index_differenceFromLast as differenceFromLast, index_dotProduct as dotProduct, index_filter as filter, index_flip as flip, index_interpolate as interpolate, index_interpolateAngle as interpolateAngle, index_interpolatorInterval as interpolatorInterval, index_interpolatorStepped as interpolatorStepped, index_isApprox as isApprox, index_isValid as isValid, index_linearSpace as linearSpace, index_max as max, index_maxFast as maxFast, index_maxIndex as maxIndex, index_min as min, index_minFast as minFast, index_minIndex as minIndex, index_minMaxAvg as minMaxAvg, index_movingAverage as movingAverage, index_movingAverageLight as movingAverageLight, index_movingAverageTimed as movingAverageTimed, index_noiseFilter as noiseFilter, index_numericPercent as numericPercent, index_numericRange as numericRange, index_numericRangeRaw as numericRangeRaw, index_piPi as piPi, index_proportion as proportion, index_quantiseEvery as quantiseEvery, index_round as round, index_scale as scale, index_scaleClamped as scaleClamped, index_scalePercent as scalePercent, index_scalePercentages as scalePercentages, index_scaler as scaler, index_scalerPercent as scalerPercent, index_scalerTwoWay as scalerTwoWay, index_softmax as softmax, index_total as total, index_totalFast as totalFast, index_validNumbers as validNumbers, index_weight as weight, index_wrap as wrap, index_wrapInteger as wrapInteger, index_wrapRange as wrapRange };
}

export { max as A, Bipolar as B, total as C, maxFast as D, totalFast as E, minFast as F, proportion as G, quantiseEvery as H, type DifferenceKind as I, differenceFromFixed as J, differenceFromLast as K, round as L, type MovingAverageTimedOptions as M, Normalise as N, scale as O, scaler as P, scaleClamped as Q, scalePercentages as R, scalePercent as S, scalerPercent as T, type ScalerTwoWay as U, scalerTwoWay as V, softmax as W, wrapInteger as X, wrap as Y, wrapRange as Z, applyToValues as a, averageWeighted as b, clamp as c, clamper as d, clampIndex as e, count as f, filter as g, flip as h, index as i, numericRange as j, numericPercent as k, isValid as l, isApprox as m, numericRangeRaw as n, linearSpace as o, movingAverageLight as p, movingAverageTimed as q, movingAverage as r, noiseFilter as s, dotProduct as t, average as u, validNumbers as v, weight as w, min as x, maxIndex as y, minIndex as z };
