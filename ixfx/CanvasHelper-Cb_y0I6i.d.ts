...
import { S as ScaleBy, a as Scaler, G as Grid, b as GridCellAccessor, c as GridCellSetter } from './Scaler-DTFJSZYG.js';
...
declare class CanvasHelper extends SimpleEventEmitter<CanvasEvents> {
    ...
    getWritableBuffer(): {
        ...
        set: GridCellSetter<Rgb8Bit>;
        flip: () => void;
    };
}
declare const imageDataAsGrid: (canvas: HTMLCanvasElement, colorSpace?: PredefinedColorSpace) => void;

export { CanvasHelper as C, type CanvasEvents as a, type CanvasHelperOpts as b, imageDataAsGrid as i };
