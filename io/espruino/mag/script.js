...
function update() {
  ...
  const xyDegrees = radianToDegree(Points.angleRadian(Points.Empty, pt));
...
function normaliseData(data) {
  ...
  // Scale value to a rough min/max. Return result will be on -1...1 bipolar scale.
...
function setup() {
  ...
  // Allow for recalibration if Z is pressed
